...
ball = Ball(100, 100, 'ball.png', 70, 70, 2, 2)
platform = Played(-10, 100, 'rocket.png', 30, 100, 5)
platform1 = Played(680, 100, 'rocket.png', 30, 100, 5)
continue_game = GameSprite(280, 10, 'pr.png', 171, 74)        
 
x_exit = 280
y_exit = 420
 
exit_game = GameSprite(x_exit, y_exit, 'exit.png', 171, 54)
restart = GameSprite(280,100, 'restart.png', 171, 54)
bg = transform.scale(image.load('fon.png'), (710, 750))
menu = transform.scale(image.load('fon_2.png'), (700, 500))
